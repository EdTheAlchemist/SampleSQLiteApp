    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            public void onClick(View view) {
                ...
                executorService.execute(new Runnable() {
                    ...
                    public void run() {
                        ...
                        myDbHelper.deleteContact(contacts.get(myViewHolder.getBindingAdapterPosition()));
                        ...
                        ((Activity) view.getContext()).runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                contacts.remove(myViewHolder.getBindingAdapterPosition());
                                // Notify the adapter that the specific item has been removed.
                                notifyItemRemoved(myViewHolder.getBindingAdapterPosition());
                            }
                        });
                    }
                });
        ...
        myViewHolder.setEditBtnOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                i.putExtra(IntentKeys.FIRST_NAME_KEY.name(), contacts.get(myViewHolder.getBindingAdapterPosition()).getFirstName());
                i.putExtra(IntentKeys.LAST_NAME_KEY.name(), contacts.get(myViewHolder.getBindingAdapterPosition()).getLastName());
                i.putExtra(IntentKeys.NUMBER_KEY.name(), contacts.get(myViewHolder.getBindingAdapterPosition()).getNumber());
                i.putExtra(IntentKeys.IMAGE_URI_KEY.name(), contacts.get(myViewHolder.getBindingAdapterPosition()).getImageUri().toString());
                i.putExtra(IntentKeys.CONTACT_ID_KEY.name(), contacts.get(myViewHolder.getBindingAdapterPosition()).getId());
                i.putExtra(IntentKeys.VIEW_HOLDER_POSITION_KEY.name(), myViewHolder.getBindingAdapterPosition());
